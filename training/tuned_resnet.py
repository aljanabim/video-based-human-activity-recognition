...
def train_model():
    ...
    base_model = keras.applications.ResNet50(input_shape=(160, 160, 3), weights='imagenet', include_top=False)
    ...
    model.fit(train_ds_scaled.take(150), epochs=1, validation_data=valid_ds_scaled.take(100))
    ...
    model.fit(train_ds_scaled.take(500), epochs=1, validation_data=valid_ds_scaled)
    # model.save("./models/trained_models/inception_tuned")
    model.save_weights("./models/checkpoints/resnet_tuned/resnet_tuned")
...
def test_model():
    ...
    model = tf.keras.models.load_model("./models/trained_models/resnet_tuned")
...
def load_model(include_top=False):
    ...
    model.load_weights("./models/checkpoints/resnet_tuned/resnet_tuned")

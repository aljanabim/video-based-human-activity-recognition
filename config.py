...
class Config():
    def __init__(self, root_path=ROOT_PATH, json_path=JSON_PATH, n_classes=174,
        ...
        # videos to be used
        self.videos_path = os.path.expanduser(
            "{}{}video".format(root_path, separator))
        # annonations of the used videos
        self.jason_label_path = json_path

        # output folders
        self.label_path = os.path.expanduser(
            "{}{}label".format(root_path, separator))
        self.frame_path = os.path.expanduser(
            "{}{}frame".format(root_path, separator))
